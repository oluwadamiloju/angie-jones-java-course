...
public class TestResults {
    ...
    public static void main(String[] args) {
        Map <String, Integer> firstGrades = getOriginalGrades();
        Map <String, Integer> secondGrades = getMakeUpGrades();

        for(var student : secondGrades.entrySet()) {
            Integer initialGrade = firstGrades.get(student.getKey());
            Integer secondGrade = secondGrades.get(student.getKey());

            if(secondGrade > initialGrade) {
        ...
        firstGrades.forEach(
                (key, value)-> System.out.println("Student: " + key + ", Grades: " + value)
        );
    }
}
